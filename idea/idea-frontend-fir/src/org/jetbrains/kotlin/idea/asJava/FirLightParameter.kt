...
internal class FirLightParameterForFirNode(
    private val parameter: KtParameterSymbol,
    ...
    override fun equals(other: Any?): Boolean =
        other is FirLightParameterForFirNode && parameter == other.parameter
}

internal class FirLightParameterForReceiver private constructor(
    private val firFunction: KtAnnotatedSymbol,
    type: KtType,
    methodName: String,
    method: FirLightMethod
) : FirLightParameter(method) {
    ...
    override fun equals(other: Any?): Boolean =
        other is FirLightParameterForReceiver && firFunction == other.firFunction
