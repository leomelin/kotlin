...
internal class FirLightAccessorMethodForFirNode(
    private val firPropertyAccessor: KtPropertyAccessorSymbol,
    ...
    override fun equals(other: Any?): Boolean =
        other is FirLightAccessorMethodForFirNode && memberIndex == other.memberIndex && firPropertyAccessor == other.firPropertyAccessor

    override fun hashCode(): Int = name.hashCode()
}

internal class FirLightSimpleMethodForFirNode(
    private val firFunction: KtFunctionSymbol,
    lightMemberOrigin: LightMemberOrigin?,
    containingClass: FirLightClassBase,
    methodIndex: Int,
    isTopLevel: Boolean,
    ...
    override fun equals(other: Any?): Boolean =
        other is FirLightSimpleMethodForFirNode && memberIndex == other.memberIndex && firFunction == other.firFunction

    override fun hashCode(): Int = name.hashCode()
}

internal class FirLightConstructorForFirNode(
    private val firFunction: KtConstructorSymbol,
    lightMemberOrigin: LightMemberOrigin?,
    containingClass: FirLightClassBase,
    methodIndex: Int,
    ...
    override fun equals(other: Any?): Boolean =
        other is FirLightConstructorForFirNode && firFunction == other.firFunction

    override fun hashCode(): Int = containingClass.name.hashCode()
}

internal abstract class FirLightMethodForFirNode(
    private val firFunction: KtFunctionLikeSymbol,
    lightMemberOrigin: LightMemberOrigin?,
    containingClass: FirLightClassBase,
    methodIndex: Int,
    argumentsSkipMask: BitSet? = null
